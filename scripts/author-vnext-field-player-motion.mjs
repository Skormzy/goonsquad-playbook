...
const result = spawnSync(blender, [
  ...
  workfile,
  '--python',
  path.join(root, 'scripts', 'blender', 'author_vnext_field_player_motion.py'),
  '--',
  '--output-blend',
  path.join(root, 'asset-inbox', 'players', 'vnext', 'goon-field-player-motion-v1.blend'),
  '--output-report',
  path.join(root, 'asset-inbox', 'players', 'vnext', 'motion-authoring-report.json'),
], {
  cwd: root,
  encoding: 'utf8',
  stdio: 'inherit',
