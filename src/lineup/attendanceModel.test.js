...
const dataset = {
  ...
  teams: [
    { id: 'monday', seasonId: 'summer-2026', leagueKey: 'york-central', leagueName: 'York Central Ball Hockey League', scheduleLabel: 'MONDAY', division: 'MONDAY TIER 5' },
    { id: 'sunday', seasonId: 'summer-2026', leagueKey: 'york-central', leagueName: 'York Central Ball Hockey League', scheduleLabel: 'SUNDAY', division: 'SUNDAY TIER 5' },
    { id: 'sunday-old', seasonId: 'winter-2026', leagueKey: 'york-central', leagueName: 'York Central Ball Hockey League', scheduleLabel: 'SUNDAY', division: 'SUNDAY TIER 5' },
  ],
  seasons: [
...
describe('fixture-scoped attendance', () => {
  ...
  it('searches known league records without duplicating account-linked players', () => {
    ...
    expect(directory[0]).toMatchObject({
      ...
      rosterLabel: 'Winter 2026 · YCBHL · Sunday Tier 5 League',
    });
  });
