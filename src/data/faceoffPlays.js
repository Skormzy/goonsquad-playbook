...
function defensiveZoneLostPhases({ right = false } = {}) {
  ...
  const strongPointId = right ? 'op-ld' : 'op-rd';
  const strongPointRole = right ? 'LD' : 'RD';
  const weakPointId = right ? 'op-rd' : 'op-ld';
  const weakPointRole = right ? 'RD' : 'LD';
  ...
  return [
    {
      ...
      desc: 'Their strong-side defender secures the draw. All three forwards recover between the ball and our net.',
      duration: 1.45,
      faceoffState: 'secured',
      ballOwner: 'op-rd',
      pos: {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 44, 54, { ball: true }),
        opponentPlayer('op-ld', 'LD', 64, 57),
        OPPONENT_GOALIE,
      ],
      ball: { x: 44, y: 54 },
    ...
    },
    {
      ...
      desc: 'Their RD moves it wide. Our winger stays inside the receiver while C protects the middle.',
      duration: 2,
      faceoffState: 'execute',
      ballOwner: 'op-rw',
      pos: {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 38, 49),
        opponentPlayer('op-ld', 'LD', 65, 50),
        OPPONENT_GOALIE,
      ],
      ball: { x: 18, y: 41 },
    ...
    },
    {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 37, 43),
        opponentPlayer('op-ld', 'LD', 66, 44),
        OPPONENT_GOALIE,
      ],
      ball: { x: 16, y: 32 },
      lanes: [],
  ...
  return [
    {
      ...
      desc: 'Their RD secures the draw. The nearest winger pressures while the other four players stay above the ball.',
      duration: 1.55,
      faceoffState: 'secured',
      ballOwner: 'op-rd',
      pos: {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 23, 85, { ball: true }),
        opponentPlayer('op-ld', 'LD', 59, 88),
        OPPONENT_GOALIE,
      ],
      ball: { x: 23, y: 85 },
    ...
    },
    {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 18, 84),
        opponentPlayer('op-ld', 'LD', 58, 85),
        OPPONENT_GOALIE,
      ],
      ball: { x: 7, y: 74 },
  ...
  return [
    {
      ...
      desc: 'Their RD wins possession. LW closes immediately while both point players hold their structure.',
      duration: 1.5,
      faceoffState: 'secured',
      ballOwner: 'op-rd',
      pos: {
    ...
    },
    {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 20, 80),
        opponentPlayer('op-ld', 'LD', 58, 81),
        opponentPlayer('op-rw', 'RW', 98, 50, { inactive: true, status: 'penalty-box' }),
        OPPONENT_GOALIE,
      ],
      ball: { x: 8, y: 60 },
  ...
  return [
    {
      ...
      desc: 'Their RD secures the draw. The four active defenders collapse inside the dots immediately.',
      duration: 1.45,
      faceoffState: 'secured',
      ballOwner: 'op-rd',
      pos: {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 26, 27, { ball: true }),
        opponentPlayer('op-ld', 'LD', 56, 35),
        OPPONENT_GOALIE,
      ],
      ball: { x: 26, y: 27 },
    ...
    },
    {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 27, 37),
        opponentPlayer('op-ld', 'LD', 57, 36),
        OPPONENT_GOALIE,
      ],
      ball: { x: 8, y: 29 },
    ...
    },
    {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 28, 35),
        opponentPlayer('op-ld', 'LD', 57, 34),
        OPPONENT_GOALIE,
      ],
      ball: { x: 7, y: 25 },
      lanes: [],
...
const dZoneLeft = defineFaceoffPlay({
  ...
  opponents: [
    ...
    opponentPlayer('op-rd', 'RD', 24, 33),
    opponentPlayer('op-ld', 'LD', 55, 33),
    OPPONENT_GOALIE,
  ],
  resolutionPhases: [
    {
    ...
    },
    {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 34, 48),
        opponentPlayer('op-ld', 'LD', 64, 49),
        OPPONENT_GOALIE,
      ],
      ball: { x: 8, y: 40 },
    ...
    },
    {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 35, 56),
        opponentPlayer('op-ld', 'LD', 66, 57),
        OPPONENT_GOALIE,
      ],
      ball: { x: 10, y: 50 },
...
const dZoneRight = defineFaceoffPlay({
  ...
  opponents: [
    ...
    opponentPlayer('op-rd', 'RD', 45, 33),
    opponentPlayer('op-ld', 'LD', 76, 33),
    OPPONENT_GOALIE,
  ],
  resolutionPhases: [
    {
    ...
    },
    {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 36, 49),
        opponentPlayer('op-ld', 'LD', 66, 48),
        OPPONENT_GOALIE,
      ],
      ball: { x: 92, y: 40 },
    ...
    },
    {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 34, 57),
        opponentPlayer('op-ld', 'LD', 65, 56),
        OPPONENT_GOALIE,
      ],
      ball: { x: 90, y: 50 },
...
const neutralZoneCenter = defineFaceoffPlay({
  ...
  opponents: [
    ...
    opponentPlayer('op-rd', 'RD', 34, 60),
    opponentPlayer('op-ld', 'LD', 66, 60),
    OPPONENT_GOALIE,
  ],
  resolutionPhases: [
    {
    ...
    },
    {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 35, 72),
        opponentPlayer('op-ld', 'LD', 65, 72),
        OPPONENT_GOALIE,
      ],
      ball: { x: 82, y: 68 },
    ...
    },
    {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 37, 82),
        opponentPlayer('op-ld', 'LD', 64, 82),
        OPPONENT_GOALIE,
      ],
      ball: { x: 78, y: 78 },
      lanes: [{ f: 'RW', t: 'C', ty: 'primary' }],
...
const offensiveZoneLeft = defineFaceoffPlay({
  ...
  opponents: [
    ...
    opponentPlayer('op-rd', 'RD', 18, 90),
    opponentPlayer('op-ld', 'LD', 61, 87),
    OPPONENT_GOALIE,
  ],
  resolutionPhases: [
    {
    ...
    },
    {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 31, 90),
        opponentPlayer('op-ld', 'LD', 59, 89),
  ...
  resolutionPhases: [
    ...
    },
    {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 28, 43),
        opponentPlayer('op-ld', 'LD', 58, 42),
        OPPONENT_GOALIE,
      ],
      ball: { x: 7, y: 38 },
    ...
    },
    {
      ...
      opp: [
        ...
        opponentPlayer('op-rd', 'RD', 30, 50),
        opponentPlayer('op-ld', 'LD', 60, 49),
        OPPONENT_GOALIE,
      ],
      ball: { x: 8, y: 54 },
